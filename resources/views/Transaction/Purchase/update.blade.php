        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-info">
                    ...
                    <form class="form-horizontal" method = "POST" action = "{{ route('purchase-order.update', $data->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            ...
                            <div class = "form-group row">
                                <div class="col-md-12">
                                    ...
                                    <div class = "col-sm-12">
                                        <textarea name = "information" class = "form-control" rows = "4">{{$data->information}}</textarea>
                                    </div>
                                </div>
                            </div>
        ...
        $(addButton).click(function(){ 
            ...
            $(wrapper).append(' <div class = "form-group row"> ' +
                    '<div class="col-sm-5">' +
                        ...
                        '<input type="text" class="form-control" id="name_raw_product_'+X+'" name = "name_raw_product[]" style="text-transform:uppercase" placeholder = "PURCHASE NAME" required>'+
                    '</div>' +
                    '<div class="col-sm-3">' +
                        '<input type="number" class="form-control" id="price_'+X+'" name = "price[]" placeholder = "PURCHASE COST" required>' +
                    '</div>' +
                    '<div class = "col-sm-2">' +
