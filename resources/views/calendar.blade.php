    ...
    var calendar = new Calendar(calendarEl, {
      ...
      <?php 
        for($s=0; $s<count($Sales); $s++)
        {
          ?>
          {
            title          : <?php echo json_encode("Revenue: ".$Sales[$s]->total ?? 0); ?>,
            start          : new Date(<?php echo json_encode($Sales[$s]->date); ?>),
            allDay         : true,
      ...
      <?php
        ...
        for($p=0; $p<count($Purchase); $p++)
        {
      ?>
          {
            title          : <?php echo json_encode("Expenses: ".$Purchase[$p]->total ?? 0); ?>,
            start          : new Date(<?php echo json_encode($Purchase[$p]->date); ?>),
            allDay         : true,
      ...
      ?>
          {
              title          : <?php echo json_encode("Orders: ".$Orders[$o]->total ?? 0); ?>,
              start          : new Date(<?php echo json_encode($Orders[$o]->date); ?>),
              allDay         : true,
              backgroundColor: '#3c8dbc', //aqua
              borderColor    : '#3c8dbc' //aqua
            },
      <?php
        }
      ?>
