...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{ asset('asset/dist/img/TeaLogo.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <!-- CHANGE BUSINESS LOGO HERE -->
      <span class="brand-text font-weight-light"></span>The Key to life is<br>&emsp;&emsp;&emsp;POSITIVI-Tea
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{ Request::is('stock/report*') ? 'menu-open' : ''}}">
            ...
            <ul class="nav nav-treeview">
              ...
              @role('A')
              <li class="nav-item">
                <a href="{{ route('/productsSummary') }}" class="nav-link {{ Request::is('/productsSummary*') ? 'active' : ''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Products Sold</p>
                </a>
              </li>
